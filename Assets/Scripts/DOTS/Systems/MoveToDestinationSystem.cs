...
namespace DOTS.Systems
{
    ...
    public class MoveToDestinationSystem : SystemBase
    {
        protected override void OnUpdate()
        {
            ...
            Entities.ForEach((ref SpeedData speedData,
                ref DestinationData destinationData, ref Translation translation) =>
            {
        ...
        //     public void Execute( Entities.ForEach, [ReadOnly] ref SpeedData speedData, 
