...
public class FindSyncEnabledMono : MonoBehaviour, IConvertGameObjectToEntity
{
    ...
    {
        var system = World.DefaultGameObjectInjectionWorld.GetOrCreateSystem<MonoSyncEnabledSystem>();
        system.Monos.Add(entity, transform.parent.gameObject);
        // Debug.Log($"convert {entity}");
